...
```text
input รับค่าสีที่ หนึ่ง และ สอง โดยที่เป็นแม่สี
และ ใช้ฟังชัน if elif else โดยจับคู่ผสมสี และแสดงผล ผลลัพะ์เป็นสีของสีที่ผสมกันออกมา
และถ้าหากเป็นสีเดียวกันผสมกัน ก็จะได้สีนั้น
Output แสดงผลลัพธ์ของแม่สีสองสีที่ผสมกัน
...
```text
รับค่าสี มาสองตัวแปร 
ถ้าเป็นสี เหลืองแดง ผสมกัน ผลลัพธ์จะเป็นสีส้ม
ถ้าเป็นสี น้ำเงินแดง ผสมกัน ผลลัพธ์จะเป็นสีม่วง
ถ้าเป็นสี เหลืองน้ำเงิน ผสมกัน ผลลัพธ์จะเป็นสีส้ม
ถ้าสีไม่ได้อยู่ในแม่สี ผลลัพธ์ จะขึ้นEror
```
...
ถ้าเป็นสี น้ำเงินแดง ผสมกัน ผลลัพธ์จะเป็นสีม่วง
ถ้าเป็นสี เหลืองน้ำเงิน ผสมกัน ผลลัพธ์จะเป็นสีส้ม
ถ้าเป็นสี สีใดสีหนึ่งผสมกะัน ผลลัพธ์ที่ได้จะเป็นสีนั้น
ถ้าสีไม่ได้อยู่ในแม่สี ผลลัพธ์ จะขึ้นEror
...
```text
เป็นสีเดียวกัน และไม่ได้อยู่ในแม่สี
...
```text
    มีสีที่เป็นแม่สีและไม่ใช่แม่สี
