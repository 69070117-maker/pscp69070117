...
```text
ร้านอาหาร คิดค่าบริการ 10เปอร์เซ็นของค่าอาหารและเครื่องเดื่ม โดยมีขั้นต่ำอยู่ที่50 และ คคิดค่าบริการสูงสุดท่1000
input ค่าอาหารและเครื่องดื่ม
output ราคาที่ลูกค้าต้องจ่ายโดยมีทศนิยมสองตำแหน่ง
```
...
```text
รับอินพุตเป็นราคาอาหารเครื่องดื่ม 
จากนั้น คิดค่าบริกาการ เป็น10เปอร์เซ็น ของราคาอาหารและเครื่องดื่ม
ถ้าราคาของค่าบริการต่ำกว่า50ให้คิดเป็น50
แลถ้าค่าบริการมากกว่า1000ให้คิดเป็น1000

และสร้างตัวแปรtotal_novat2 ขึ้นมาเก็บค่าเป็นค่าราคาอาหารและเครื่องดื่มรวมกับค่าบริการ
และสร้างตัวแปร  vat เพื่อคิดราคาของvat 
และสร้างตัวแปรสุดท้าย finaltotal เพื่อคิดราคารวมทั้งหมด โดยให้ตัวแปรนั้นมีค่าเท่ากับ total_novat2  + vat
และ แสดงoutput
```
...
```text
เป็นราคาที่สูง เพื่อทดสอบ ค่าบริการ สูงสุด1000
```
...
``` เป็นราคาที่ต่ำ เพื่อทดสอบค่าบริการต่ำสุด 50
...
```text
hint และ วิธีใส่ทศนิยมสองตำแหน่ง
```
