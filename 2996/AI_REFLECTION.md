...
|---|---|---|
| I read the relevant workflow before using AI. | Yes STUDENT_WORKFLOW_WEB_CHAT.md`|
| I used `AGENTS.md` |  | Briefly explain how you used or followed it |
| I wrote my own problem understanding before asking AI for help. |  
| Briefly say where you wrote it, |yes as `submission.md` |
| I wrote my own first plan before asking AI for help. |  Yes |
| I used AI as a coach, reviewer, debugger, or test-case helper, not as a full-answer generator. |  | coach |
...
```คำสั่งในการที่ทำให้ข้อความย้อนกลับ
...
```ทำความเข้าใจ ทบทวนความรู้ ที่เอไอแนะนำ และลองเทสเคสที่คิดเองอีกสามเทสเคส
